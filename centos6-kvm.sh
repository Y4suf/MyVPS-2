...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>Setup by Orang Ganteng<pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/vps.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/iptables.up.rules"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/mrtg-mem.sh"
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/bmon"
fi
chmod +x /usr/bin/bmon

# User Status
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/user-list
mv ./user-list /usr/local/bin/user-list
chmod +x /usr/local/bin/user-list

# Install Dos Deflate
apt-get -y install dnsutils dsniff
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/ddos-deflate-master.zip
...
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/update
mv ./update /usr/bin/update
chmod +x /usr/bin/update

# instal Buat Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/buatakun
mv ./buatakun /usr/bin/buatakun
chmod +x /usr/bin/buatakun

# instal Generate Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/generate
mv ./generate /usr/bin/generate
chmod +x /usr/bin/generate

# instal Generate Akun Trial
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/trial
mv ./trial /usr/bin/trial
chmod +x /usr/bin/trial

# instal  Ganti Password Akun SSH/VPN
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/userpass
mv ./userpass /usr/bin/userpass
chmod +x /usr/bin/userpass

# instal Generate Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/userrenew
mv ./userrenew /usr/bin/userrenew
chmod +x /usr/bin/userrenew

# instal Hapus Akun SSH/OpenVPN
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/userdelete
mv ./userdelete /usr/bin/userdelete
chmod +x /usr/bin/userdelete

# instal Cek Login Dropbear & OpenSSH
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/userlogin
...
# Install Menu
cd
wget https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/menu
mv ./menu /usr/local/bin/menu
chmod +x /usr/local/bin/menu

# download script
cd
wget -O /issue.net.txt "https://raw.githubusercontent.com/Y4suf/MyVPS-2/master/config/banner"
...
# info
clear
echo "Setup by Orang Ganteng"  | tee -a log-install.txt
